...
def class_text_to_int(row_label):
    label_map_dic= label_map_util.get_label_map_dict('carla_training/carla_label_map.pbtxt')
    return label_map_dic[row_label]
...
def create_tf_example(group, path):
    ...
    filename = group.filename.replace(".png",".jpeg").encode('utf8')
    image_format = b'jpeg'
    xmins = []
    xmaxs = []
    ymins = []
